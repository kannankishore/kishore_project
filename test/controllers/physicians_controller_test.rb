...
class PhysiciansControllerTest < ActionController::TestCase
  ...
  test "should create physician" do
    assert_difference('Physician.count') do
      post :create, physician: { appointment_id: @physician.appointment_id, area: @physician.area, clinic: @physician.clinic, name: @physician.name, patient_id: @physician.patient_id }
    end
  ...
  test "should update physician" do
    patch :update, id: @physician, physician: { appointment_id: @physician.appointment_id, area: @physician.area, clinic: @physician.clinic, name: @physician.name, patient_id: @physician.patient_id }
    assert_redirected_to physician_path(assigns(:physician))
  end
